...
#include "CarChaseSportsCar.h"
#include "CarChaseSportsWheelFront.h"
#include "CarChaseSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarChaseSportsCar::ACarChaseSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCarChaseSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCarChaseSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCarChaseSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCarChaseSportsWheelRear::StaticClass();
